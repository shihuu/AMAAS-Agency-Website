...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  const badgeText = content['hero.badge'] || 'FULL-STACK WEB DEVELOPER & DIGITAL SOLUTIONS SPECIALIST';
  const headlineText = content['hero.headline'] || 'Engineering Digital Solutions';
  const subheadlineText = content['hero.subheadline'] || 'That Help Businesses Scale.';
  const primaryCta = content['hero.primary_cta_text'] || 'Start Your Project';
  const secondaryCta = content['hero.secondary_cta_text'] || 'View Selected Work';
    ...
    <section id="home" className="relative pt-32 pb-16 md:pt-44 md:pb-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            "I don't just build websites. I build professional digital solutions that help businesses establish their online presence, improve their workflow and grow."
          </motion.div>
          ...
          >
            Custom business websites, custom web applications, and resilient frontend + backend architectures crafted for clients in the US, UK, Canada, Australia, Europe, Middle East and globally.
          </motion.p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
              ...
              <div className="md:col-span-5 flex flex-col items-center md:items-start text-center md:text-left border-b md:border-b-0 md:border-r border-white/[0.08] pb-6 md:pb-0 md:pr-6">
                ...
                <div className="mt-2 text-xs text-[#bdc8d1] leading-relaxed">
                  Tailored web applications, business platforms, and conversion-focused digital systems designed for ambitious global brands.
                </div>
                <div className="mt-4 flex items-center space-x-2 text-[11px] text-[#67e8f9] font-display font-medium">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#38bdf8] animate-pulse" />
                  <span>Now Booking Q4 International Projects</span>
                </div>
              </div>
              ...
              <div className="md:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-[#050B14]/60 border border-white/[0.06] flex flex-col justify-between hover:border-[#38bdf8]/30 transition-all duration-200 hover:-translate-y-0.5">
                  <div className="text-xs font-display font-bold uppercase tracking-wider text-[#7bd0ff] flex items-center space-x-1.5">
                    ...
                    <span>Conversion & Business First</span>
                  </div>
                  <div className="mt-2 text-sm text-white font-medium">
                    Intuitive user journeys structured around your real operational goals.
                  </div>
                  <div className="mt-3 text-[11px] text-[#bdc8d1]/75 flex items-center space-x-1">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#38bdf8]" />
                    <span>High-performance lead generation</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-[#050B14]/60 border border-white/[0.06] flex flex-col justify-between hover:border-[#38bdf8]/30 transition-all duration-200 hover:-translate-y-0.5">
                  ...
                  <div className="mt-2 text-sm text-white font-medium">
                    Frontend UI, backend APIs, relational databases, and custom workflows.
                  </div>
                  <div className="mt-3 text-[11px] text-[#bdc8d1]/75 flex items-center space-x-1">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#38bdf8]" />
